...
// customerDue Update table method create ********************  
    ...
    private void initComponents() {
        ...
        jPanel5.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 110, -1));
        ...
        jPanel48.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 450, 120, 50));
        ...
        jPanel48.add(btnCustomerSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 450, 120, 50));
        ...
        jLabel58.setText("Customer Due");
        jPanel48.add(jLabel58, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 380, 170, 30));

        cusDue.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        cusDue.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel48.add(cusDue, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 380, 280, 30));
        ...
        jPanel52.add(jLabel61, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 150, 150, 30));

        jLabel62.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel62.setText("Cus Due Id");
        jPanel52.add(jLabel62, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 150, 30));

        jLabel63.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel63.setText("Customer Name");
        jPanel52.add(jLabel63, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 170, 30));
        ...
        jPanel52.add(jLabel65, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, 160, 30));

        jLabel66.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel66.setText("Phone Number");
        jPanel52.add(jLabel66, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 160, 30));

        jLabel67.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel67.setText("Email");
        jPanel52.add(jLabel67, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 230, 100, 30));

        jTextField2.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jPanel52.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, 250, -1));
        ...
        jPanel52.add(jScrollPane13, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 300, 1000, 210));
        ...
        jPanel53.add(jLabel68, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1020, 60));
        ...
        jPanel53.add(jLabel72, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 190, 110, 30));
        jPanel53.add(payDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 100, 300, 30));
        ...
        jPanel53.add(jScrollPane14, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 150, 300, -1));
        ...
        jPanel53.add(payDue, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 270, 300, 30));

        jLabel75.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel75.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel75.setText("CustomerDue");
        jPanel53.add(jLabel75, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 270, 180, 30));
        ...
        jPanel53.add(jScrollPane15, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, 980, 190));

        paySubmit.setBackground(new java.awt.Color(102, 204, 0));
        paySubmit.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        jPanel53.add(paySubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 330, 110, 40));

        jPanel53.add(payName, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 160, 170, -1));
...
// customer table data from customer field***********************   
    ...
    public void getAllCustomerDueDecreament() {
        ...
        try {
            ...
            ps.setFloat(1, payDu);
            ps.setString(2, payNa);

            ps.executeUpdate();
            ps.close();
            con.getCon().close();

            JOptionPane.showMessageDialog(prCompanyName, "Customer Due  is  Decreament");

        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(prCompanyName, "Customer Due is Not Decreament");
            Logger.getLogger(DashBoard.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void paySubmitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_paySubmitMouseClicked
        ...
        payDu=Float.valueOf(payDue.getText());
        payNa=payName.getSelectedItem().toString();
        
        try {
            ps=con.getCon().prepareStatement(sql);
            
            ps.setString(1, payNa);
            ps.setString(2, payNumber.getText());
            ps.setString(3, payEmail.getText());
            ps.setString(4, payAddress.getText());
            
            ps.setDate(5, convertUtilDateToSqlDate(payDate.getDate()));
            ...
            JOptionPane.showMessageDialog(prCompanyName, "Pay Data is Save");
             getAllCustomerDueDecreament();
             
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(prCompanyName, "Pay Data is not Save");
            Logger.getLogger(DashBoard.class.getName()).log(Level.SEVERE, null, ex);
        }
...
// Default Customer Due Table create ************************
    ...
    public void getCustomerDueIncreament() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(prCompanyName, "Due Data is  Increament");

        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(prCompanyName, "Due Data is Not Increament");
