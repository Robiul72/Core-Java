...
public class LoginPage extends javax.swing.JFrame {
    ...
    DashBoard board = new DashBoard();  // dashboard k call kora hoyeche
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Wellcome to JEE/CCSL");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assit/java 2.png"))); // NOI18N
    ...
    private void btnLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLoginMouseClicked
        ...
        if(userName.equalsIgnoreCase(userNameU) && pass.equals(passU)){
            ...
            dispose(); // login page off kora hoyeche
            
            board.setLocationRelativeTo(null);   // new page run kora hoyeche
